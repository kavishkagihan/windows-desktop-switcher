...
; In the original script, once a windows is moved to a workspace our-
; view also moves to that workspace. But I have set it not to do so-
; by commenting out line 200 in desktop_switcher.ahk 
